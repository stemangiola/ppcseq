...
#include "stanExports_negBinomial_MPI.h"

RCPP_MODULE(stan_fit4negBinomial_MPI_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_negBinomial_MPI")
